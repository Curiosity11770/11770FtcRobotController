...
@Autonomous(name="BluePreTeleOpAuto", group="Linear OpMode")
@Config
public class BluePreTeleOpAuto extends LinearOpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            STRAFEPATH = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(32.35, 136), new Pose(35.975, 82.510))
                    )
